            ...
            @foreach ($restaurants as $restaurant)
                <div class="restaurant-card p-md-3 p-lg-4 d-flex gap-5 col-xxl-10">
                    <a class="text-decoration-none text-dark d-flex align-items-center gap-sm-3 gap-md-5"
                        ...
                        <div class="col-10 col-sm-6 col-md-4 col-lg-6 d-flex flex-column justify-content-start gap-3 py-5">
                            <div>
                    ...
                    <div class="edit-and-delete d-flex flex-column gap-2 align-items-end">
                        <a class="text-decoration-none" href="{{ route('admin.restaurants.orders', $restaurant) }}"><button
                                type="button" class="order-button">
                                <i class="fa-solid fa-clipboard-list"></i>
                            </button>
                        </a>

                        <a class="text-decoration-none" href="{{ route('admin.restaurants.edit', $restaurant) }}"><button
