...
@section('content')
            ...
            <div class="col d-flex justify-content-center">
                <div class="card rounded-3" style="width:18rem;">
                    @if (str_contains($restaurant->image, 'http'))
                        <img class="rounded-top-3" src="{{ $restaurant->image }}">
                    @else
                        <img class="rounded-top-3" src="{{ asset('storage/' . $restaurant->image) }}"
    ...
    <h2 class="my-5 text-center">- MENU -</h2>

    <div class="container mb-5">
        <button class="btn btn-success my-3">
            <a href="{{ route('admin.restaurant.dishes.create', $restaurant->id) }}"
                class="text-decoration-none text-white fw-bold mb-5">CREA
                ...
                <div class="col">
                    <div class="card rounded-3" style="width: 18rem;">
                        @if (str_contains($dish->image, 'http'))
                            <img class="rounded-top-3" src="{{ asset($dish->image) }}" alt="Dish preview">
                        @else
                            <img class="rounded-top-3" src="{{ asset('storage/' . $dish->image) }}" alt="..">
                        @endif
